        ...
        <div class="w-full flex justify-between mb-2  items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button id="importButton"
                    ...
                    class="px-5 sm:px-10 py-2 rounded-md bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700  dark:text-white">Import
                </button>
            </div>
                    ...
                    <tr class="text-gray-800 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700 rounded-md">
                        ...
                        <td class="py-2 px-1 whitespace-nowrap max-w-[20ch] truncate">
                            ...
                            <button
                                ...
                                class="py-1 px-4 bg-red-100 hover:bg-red-200 dark:bg-red-800 dark:hover:bg-red-700 dark:text-white rounded-md deleteButton">Delete</button>
                        </td>
                    </tr>
                    @empty
                        <tr>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-3 md:p-4 border-b rounded-t dark:border-gray-600 border-gray-200">
                    <h3 id="labelModal" class="text-lg font-semibold text-gray-900 dark:text-white"></h3>
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="ModalCategory">
                ...
                <form id="formCategory" class="p-3 md:p-4" action="" method="">
                    ...
                    <div class="grid gap-3 mb-3 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="nameCategory" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category Name</label>
                            <input type="text" name="nameCategory" id="nameCategory" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500" placeholder="Enter category name">
                        </div>
                        <div class="col-span-2">
                    ...
                    <button type="submit" class="text-sm px-5 py-2.5 w-full  font-medium rounded-lg text-slate-800 bg-slate-200 hover:bg-slate-300 dark:bg-gray-600 dark:hover:bg-gray-800 dark:text-white">
                        Submit Category
                    </button>
                </form>
            </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-3 md:p-4 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="ModalImportCategory">
                        <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                        <span class="sr-only">Close modal</span>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        noResultsMessage.innerHTML = '<td colspan="4" class="text-center py-3 text-gray-500 dark:text-gray-400">No Category found.</td>';
