<x-layoutdsbd title="{{ $title }}" user="{{ $user['name'] }}" role="{{ $user['role'] }}">
    <div class="container mx-auto w-full">
        <div class="w-full flex justify-between mb-2">
            <h1 class="text-xl py-2 font-semibold text-gray-900 dark:text-gray-100 whitespace-nowrap overflow-hidden">Category</h1>
            <button id="addButton"
                    ...
                    data-method="POST"
                    class="px-5 sm:px-10 py-2 rounded-md border-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:border-0 dark:text-white">Add Category</button>
        </div>
            ...
            <table id="tabelData" class="table-auto w-full text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 dark:border-gray-700 rounded-md">
                        ...
                        <td class="py-3 px-1 whitespace-nowrap max-w-[20ch] truncate text-gray-800 dark:text-gray-200">{{ $category->category_name }}</td>
                        <td class="py-3 px-1 whitespace-nowrap max-w-[20ch] truncate text-gray-800 dark:text-gray-200">{{ $category->description }}</td>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <form id="formCategory" class="p-3 md:p-4" action="" method="">
                    ...
                    <button type="submit" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full dark:bg-gray-600 dark:hover:bg-gray-800 dark:focus:ring-gray-800">
                        Submit Category
                    </button>
                </form>
            </div>
