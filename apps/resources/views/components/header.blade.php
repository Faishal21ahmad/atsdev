<header  id="header" class="p-4 pb-0 sm:pb-4 sm:ml-64 absolute top-0 z-40">
    <div class="px-4 fixed top-0 left-0 right-0 h-16 bg-white dark:bg-slate-800 flex items-center justify-between sm:ml-64 lg:px-14 border-b-2 dark:border-slate-800">        
