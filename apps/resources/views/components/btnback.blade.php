...
<a href="{{ $href }}" 
    class="flex items-center justify-evenly gap-1 px-3 py-2 w-32 rounded-lg  text-slate-700 hover:bg-slate-200 transition duration-200 ease-in-out
    ...
    <span class="inline-block pt-0.5">Back</span>
</a>
