...
<div class="container mx-auto w-full">
    <div class="w-full flex justify-between mb-2">
        <h1 class="text-xl py-2 font-semibold text-gray-900 dark:text-gray-100 whitespace-nowrap overflow-hidden">Roles</h1>
        <button id="addButton" 
                ...
                data-method="POST"
                class="px-5 sm:px-10 py-2 rounded-md border-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:border-0 dark:text-white">Add Roles</button>
    </div>
        ...
        <table id="tabelData" class="table-auto w-full text-left">
            <thead>
                <tr class="border-b border-gray-200 dark:border-gray-700 rounded-md">
                    ...
                    <th class="py-3 px-1 whitespace-nowrap text-gray-900 dark:text-gray-100">Nama Roles</th>
            ...
            <tbody>
                @forelse ($roles as $role)
                    <tr class="border-b border-gray-200 dark:border-gray-700 rounded-md">
                        ...
                        <td class="py-3 px-1 whitespace-nowrap max-w-[20ch] truncate text-gray-800 dark:text-gray-200">{{ $role->role_name }}</td>
                        <td class="py-3 px-1 whitespace-nowrap max-w-[20ch] truncate text-gray-800 dark:text-gray-200">{{ $role->description }}</td>
